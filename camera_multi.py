...
def callback_right(msg):
    ...
    mtx = np.array([[474.739827443192,	0,	314.352203692228 ], # 758.264986 0.000000 411.309665      637.672100, 0.000000, 309.566959
    [ 0,	478.254239412746,	192.190066856112   ], #  0.000000, 640.079980, 271.465664
    [  0.        ,   0.        ,   1.        ]])
    dist = np.array([[-0.385067072548098,	0.125765772149079,0,0,0 ]])  #    -0.362970, 0.114217, 0.000856, -0.000690, 0.000000
...
def callback_left(msg):
    ...
    mtx = np.array([[472.976456312431,	0,	324.831123027368 ], # 656.463286, 0.000000, 319.359193
    [  0,	475.839201370211,	152.884147573049 ], #   0.000000, 657.446167, 221.879265
    [  0.        ,   0.        ,   1.        ]])
    dist = np.array([[-0.363268871835358,	0.122230476223735,	0,	0,	0]]) #   -0.391683, 0.139876, -0.006383, 0.008809, 0.000000
...
if __name__ == '__main__':
    ...
    rospy.Subscriber("/camera_right/camera1/usb_cam/image_raw",Image,callback_right)   #/camera1/usb_cam/image_raw  /camera_right/camera1/usb_cam/image_raw
    rospy.Subscriber("/camera_left/camera2/usb_cam/image_raw",Image,callback_left)
